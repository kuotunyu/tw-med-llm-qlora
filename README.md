...
**MedQA 72.05% · TMMLU+ 61.53% · 28,758 次正式生成 · Windows RTX 4090 實機驗收**
...
我一直想知道：台灣語境模型經過小規模、可重現的 QLoRA 微調後，能否在醫療選擇題上超越同尺寸基準，同時保留一般知識能力。這個專案把資料隔離、訓練、雙軌評估、本機推論與安全發布串成一條可稽核流程；每個公開結論都能追溯到固定 revision、SHA-256 或機器可讀報告。
...
flowchart TD
    ...
    H --> L(["Windows RTX 4090 / Ollama 驗收"])
```
...
- MedQA：`bigbio/med_qa@e04abdc0672c54547fa1dbe36cfefc000e4f2657`；test split 從未進入 trainer。
- TMMLU+：`ikala/tmmluplus@81d53e38340c9ade988f7fed8996da6554b504f3`；僅用於正式評估。
- base model：`taide/Gemma-3-TAIDE-12b-Chat-2602@4de0b93b99f8b61b59c40d019fd593bdd1c42249`。
...
- [RTX 4090 acceptance](reports/phase5/20260722T131736Z-acceptance.json)
...
- adapter revision：`b1d8f74291da75d0719b5a3ea0d088ee8236e096`。
- 最小發布集合：`adapter_config.json`、`adapter_model.safetensors`、模型卡與授權 PDF；遠端逐檔 SHA-256 已驗證。
- RTX 4090：模型載入 84.69 秒、first token 1.589 秒、peak allocated 8.05 GiB。
